...
print(f'first player hand: {find_best_combination(first_player_hand, parsed_board).name} - '
      f'{find_best_combination(first_player_hand, parsed_board).cards}')
print(f'Second player hand: {find_best_combination(second_player_hand, parsed_board).name} - '
